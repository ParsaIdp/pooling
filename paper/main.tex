...
\title{\textbf{Adaptive Pooling Innovations for Efficient Deep Learning}\\[0.3em]
\large A Comprehensive Study of Learnable Downsampling Strategies}

\author{
\textbf{Parsa Idehpour}\\[0.2em]
University of Pennsylvania\\[0.2em]
\texttt{ididea@seas.upenn.edu}
}

\date{ESE-5390 Machine Learning Systems \quad---\quad Fall 2025}
...
\smallskip
\noindent\textbf{Keywords:} Deep Learning, Pooling Layers, CNN, Adaptive Computation, Computer Vision
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/method_diagram.png}
    \caption{Overview of the 8 pooling methods. Each panel shows: method name, category (Baseline/Learnable/Novel), a 2$\times$2 input example with output, the core formula, and key properties. Our novel contributions (Attention-Weighted and Stochastic Mix) are highlighted in pink.}
    \label{fig:methods}
\end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/ablation_heatmap.png}
...
\begin{figure}[t]
\centering
    \includegraphics[width=\linewidth]{figures/overhead.png}
